    ...
    public ArrayList<Elektrownia> elektrownie = new ArrayList<>() {
        {
            ...
            add(new ElektrowniaFotowoltaiczna("OrskSolar", "Orsk", 0, 550, 10, 10, wlasciciele.getWlasciciele().get(3), false, 0, dystrybutorzy.getDystrybutorzyPradu().get(2), 90000, 45000, 22500, 0, 0, 10));
            ...
            add(new ElektrowniaFotowoltaiczna("FranceSolar", " Toul-Rosi", 0, 550, 10, 10, wlasciciele.getWlasciciele().get(3), false, 0, dystrybutorzy.getDystrybutorzyPradu().get(4), 180000, 90000, 30000, 0, 0, 10));
            ...
            add(new ElektrowniaWeglowa("Dziecmor", "Dziecmor", 0, 750, 10, 10, wlasciciele.getWlasciciele().get(0), false, "roksana wegiel", 3f, 10, dystrybutorzy.getDystrybutorzyPradu().get(1), 103.5f, dostawcy.dostawcyWegla.get(1), 190f, 93750, 45500, 31250, 0, 0, 10));
            ...
            add(new ElektrowniaWeglowa("Niederaus", "Bergheim", 0, 750, 10, 10, wlasciciele.getWlasciciele().get(0), false, "roksana wegiel", 3f, 10, dystrybutorzy.getDystrybutorzyPradu().get(3), 103.5f, dostawcy.dostawcyWegla.get(3), 190f, 218750, 109375, 43750, 0, 0, 10));
            ...
            add(new ElektrowniaGazowa("Centrale", "Reno-Pari", 0, 800, 10, 10, wlasciciele.getWlasciciele().get(0), false, "gaz", 4.75f, 10, dystrybutorzy.getDystrybutorzyPradu().get(4), 123f, dostawcy.dostawcyGazu.get(4), 200f, 270000, 135000, 60000, 0, 0, 10));
        }
    };
}
